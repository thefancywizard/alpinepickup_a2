...
class __TwigTemplate_41d53db05b916bbea269d91797cc937b extends \Twig\Template
{
    private $source;
    private $macros = [];
        ...
        <nav class=\"gin-breadcrumb\" role=\"navigation\" aria-labelledby=\"system-breadcrumb\">
          ...
          <ol class=\"gin-breadcrumb__list\">
            ...
            if ((($context["entity_edit_url"] ?? null) && ($context["entity_title"] ?? null))) {
                ...
                echo $this->extensions['Drupal\Core\Template\TwigExtension']->renderVar($this->extensions['Drupal\gin_lb\TwigExtension\GinLbExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(($context["entity_edit_url"] ?? null), 18, $this->source), "html", null, true));
                echo "\">";
...
{% endif %}
", "modules/contrib/gin_toolbar/templates/toolbar.html.twig", "/home/deepsea1/public_html/alpinepickup/web/modules/contrib/gin_toolbar/templates/toolbar.html.twig");
    }
