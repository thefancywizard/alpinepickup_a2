...
class __TwigTemplate_4223f3d788a17aff2db7edb30b233ea0 extends \Twig\Template
{
    private $source;
    private $macros = [];
    ...
    ";
            // line 24
            echo $this->extensions['Drupal\Core\Template\TwigExtension']->renderVar($this->extensions['Drupal\gin_lb\TwigExtension\GinLbExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(($context["children"] ?? null), 24, $this->source), "html", null, true));
            echo "
  </div>
";
        }
...
{% if children %}
  ...
  {# flex classes removed for compatibility with DXPR Theme boxed layout theme setting #}
  <div class=\"dialog-off-canvas-main-canvas\" data-off-canvas-main-canvas>
    {{ children }}
  </div>
{% endif %}
", "themes/contrib/dxpr_theme/templates/off-canvas-page-wrapper.html.twig", "/home/deepsea1/public_html/alpinepickup/web/themes/contrib/dxpr_theme/templates/off-canvas-page-wrapper.html.twig");
    }
