...
class __TwigTemplate_87c0ccb981346fff58065211a7e9d025 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
";
    ...
    ";
            // line 24
            echo $this->extensions['Drupal\Core\Template\TwigExtension']->renderVar($this->extensions['Drupal\gin_lb\TwigExtension\GinLbExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(($context["content"] ?? null), 24, $this->source), "html", null, true));
            echo "
  </div>
";
        }
...
{% endif %}
", "themes/contrib/gin/templates/regions/region.html.twig", "/home/deepsea1/public_html/alpinepickup/web/themes/contrib/gin/templates/regions/region.html.twig");
    }
