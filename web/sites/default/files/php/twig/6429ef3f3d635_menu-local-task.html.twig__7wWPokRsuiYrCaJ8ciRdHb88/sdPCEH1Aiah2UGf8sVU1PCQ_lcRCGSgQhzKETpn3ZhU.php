...
class __TwigTemplate_957f4d8f17c9e13c4410a780dee7dc70 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
($context["is_active"] ?? null)) ? ("js-active-tab") : (""))];
        // line 26
        echo "<li";
        echo $this->extensions['Drupal\Core\Template\TwigExtension']->renderVar($this->extensions['Drupal\gin_lb\TwigExtension\GinLbExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, ($context["attributes"] ?? null), "addClass", [0 => ($context["classes"] ?? null)], "method", false, false, true, 26), 26, $this->source), "html", null, true));
        echo ">
  ";
        // line 27
        echo $this->extensions['Drupal\Core\Template\TwigExtension']->renderVar($this->extensions['Drupal\gin_lb\TwigExtension\GinLbExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(($context["link"] ?? null), 27, $this->source), "html", null, true));
        echo "
  ";
        // line 28
        if ((($context["is_active"] ?? null) && (($context["level"] ?? null) == "primary"))) {
            ...
            echo $this->extensions['Drupal\Core\Template\TwigExtension']->renderVar($this->extensions['Drupal\Core\Template\TwigExtension']->renderVar(t("Tabs display toggle")));
...
", "core/themes/claro/templates/navigation/menu-local-task.html.twig", "/home/deepsea1/public_html/alpinepickup/web/core/themes/claro/templates/navigation/menu-local-task.html.twig");
    }
