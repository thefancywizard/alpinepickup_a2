...
class __TwigTemplate_c42c02a35e5f38aae37ae63ef23b5fb5 extends \Twig\Template
{
    private $source;
    private $macros = [];
  ...
  <nav role=\"navigation\" class=\"tabs-wrapper is-horizontal is-collapsible\" aria-labelledby=\"primary-tabs-title\" data-drupal-nav-tabs>
    <ul class=\"tabs tabs--primary clearfix\" data-drupal-nav-tabs-target>";
            // line 19
            echo $this->extensions['Drupal\Core\Template\TwigExtension']->renderVar($this->extensions['Drupal\gin_lb\TwigExtension\GinLbExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(($context["primary"] ?? null), 19, $this->source), "html", null, true));
            echo "</ul>
  </nav>
";
        }
  ...
  <nav role=\"navigation\" class=\"tabs-wrapper tabs-wrapper--secondary is-horizontal\" aria-labelledby=\"secondary-tabs-title\">
    <ul class=\"tabs tabs--secondary clearfix\">";
            // line 25
            echo $this->extensions['Drupal\Core\Template\TwigExtension']->renderVar($this->extensions['Drupal\gin_lb\TwigExtension\GinLbExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(($context["secondary"] ?? null), 25, $this->source), "html", null, true));
            echo "</ul>
  </nav>
";
        }
...
{% endif %}
", "core/themes/claro/templates/menu-local-tasks.html.twig", "/home/deepsea1/public_html/alpinepickup/web/core/themes/claro/templates/menu-local-tasks.html.twig");
    }
