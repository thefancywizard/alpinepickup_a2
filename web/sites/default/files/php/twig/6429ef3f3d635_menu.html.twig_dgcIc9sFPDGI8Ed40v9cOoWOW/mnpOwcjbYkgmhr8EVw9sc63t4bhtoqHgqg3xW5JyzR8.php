...
class __TwigTemplate_7d6337df850d15e812cb07640e776f0e extends \Twig\Template
{
    private $source;
    private $macros = [];
        ...
        try {
            ...
            if (($context["items"] ?? null)) {
                ...
                if ((($context["menu_level"] ?? null) == 0)) {
                    // line 33
                    echo "      <ul";
                    echo $this->extensions['Drupal\Core\Template\TwigExtension']->renderVar($this->extensions['Drupal\gin_lb\TwigExtension\GinLbExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, ($context["attributes"] ?? null), "addClass", [0 => [0 => "nav navbar-nav"]], "method", false, false, true, 33), 33, $this->source), "html", null, true));
                    echo ">
    ";
                } else {
                    // line 35
...
{% macro menu_links(items, attributes, menu_level) %}
  ...
  {% endif %}
{% endmacro %}
", "themes/contrib/bootstrap5/templates/navigation/menu.html.twig", "/home/deepsea1/public_html/alpinepickup/web/themes/contrib/bootstrap5/templates/navigation/menu.html.twig");
    }
