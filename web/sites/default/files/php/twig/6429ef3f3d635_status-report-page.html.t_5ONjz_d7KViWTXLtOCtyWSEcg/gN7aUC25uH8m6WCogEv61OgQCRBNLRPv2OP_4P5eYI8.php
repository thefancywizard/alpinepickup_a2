...
class __TwigTemplate_9f3ced6574886007af9dc7a4d26f8512 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
($context["counters"] ?? null)) == 2)) {
  ...
  ";
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["counter"]) {
            ...
            echo $this->extensions['Drupal\Core\Template\TwigExtension']->renderVar($this->extensions['Drupal\gin_lb\TwigExtension\GinLbExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(($context["element_width_class"] ?? null), 21, $this->source), "html", null, true));
            echo "\">
      ";
            // line 22
            echo $this->extensions['Drupal\Core\Template\TwigExtension']->renderVar($this->extensions['Drupal\gin_lb\TwigExtension\GinLbExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed($context["counter"], 22, $this->source), "html", null, true));
            echo "
    </div>
  ";
        }
...
";
        // line 27
        echo $this->extensions['Drupal\Core\Template\TwigExtension']->renderVar($this->extensions['Drupal\gin_lb\TwigExtension\GinLbExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(($context["general_info"] ?? null), 27, $this->source), "html", null, true));
        echo "
";
        // line 28
        echo $this->extensions['Drupal\Core\Template\TwigExtension']->renderVar($this->extensions['Drupal\gin_lb\TwigExtension\GinLbExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(($context["requirements"] ?? null), 28, $this->source), "html", null, true));
        echo "
";
    }
...
{{ general_info }}
{{ requirements }}
", "core/themes/claro/templates/status-report-page.html.twig", "/home/deepsea1/public_html/alpinepickup/web/core/themes/claro/templates/status-report-page.html.twig");
    }
