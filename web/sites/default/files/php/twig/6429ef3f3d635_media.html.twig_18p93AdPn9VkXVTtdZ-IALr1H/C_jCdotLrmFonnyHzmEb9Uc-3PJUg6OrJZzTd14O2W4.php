...
class __TwigTemplate_2ffa6a55c0a9f409e7bae28efc7c55ce extends \Twig\Template
{
    private $source;
    private $macros = [];
...
($context["view_mode"] ?? null)) ? (("media--view-mode-" . \Drupal\Component\Utility\Html::getClass($this->sandbox->ensureToStringAllowed(($context["view_mode"] ?? null), 20, $this->source)))) : (""))];
  ...
  ";
        // line 24
        echo $this->extensions['Drupal\Core\Template\TwigExtension']->renderVar($this->extensions['Drupal\gin_lb\TwigExtension\GinLbExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, ($context["title_suffix"] ?? null), "contextual_links", [], "any", false, false, true, 24), 24, $this->source), "html", null, true));
        echo "
  ";
        // line 25
        if (($context["content"] ?? null)) {
            // line 26
            echo "    ";
            echo $this->extensions['Drupal\Core\Template\TwigExtension']->renderVar($this->extensions['Drupal\gin_lb\TwigExtension\GinLbExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(($context["content"] ?? null), 26, $this->source), "html", null, true));
            echo "
  ";
        }
        // line 28
...
", "themes/contrib/bootstrap5/templates/content/media.html.twig", "/home/deepsea1/public_html/alpinepickup/web/themes/contrib/bootstrap5/templates/content/media.html.twig");
    }
